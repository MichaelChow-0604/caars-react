  ...
  const runInspection = () => {
    ...
    setResults({
      ...
      headerScroller: {
        ...
        computedPaddingRight: getComputed(headerScroller ?? null, 'padding-right'),
      ...
      timegridCol: {
        exists: !!timegridCol,
        computedBorderRight: getComputed(timegridCol ?? null, 'border-right'),
        computedBorderRightWidth: getComputed(timegridCol ?? null, 'border-right-width'),
        computedBorderRightStyle: getComputed(timegridCol ?? null, 'border-right-style'),
        computedBorderRightColor: getComputed(timegridCol ?? null, 'border-right-color'),
      },
      colHeaderCell: {
        exists: !!firstHeaderCell,
        text: firstHeaderCell?.textContent?.substring(0, 50) || 'N/A',
        computedBorderRight: getComputed(firstHeaderCell ?? null, 'border-right'),
        computedBorderRightWidth: getComputed(firstHeaderCell ?? null, 'border-right-width'),
        computedBorderRightStyle: getComputed(firstHeaderCell ?? null, 'border-right-style'),
        computedBorderRightColor: getComputed(firstHeaderCell ?? null, 'border-right-color'),
      },
      scrollgrid: {
        exists: !!scrollgrid,
