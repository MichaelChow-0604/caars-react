              ...
              {headerGroup.headers.map((header) => (
                <div
                  ...
                  className={cn(
                    ...
                    (header.column.columnDef.meta as { colClass?: string })
              ...
              <div
                ...
                className={cn(
                  ...
                  row.original.title === DEMO_DOCUMENT_TITLE &&
                    "hover:bg-caars-neutral-grey-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-caars-primary-1/40"
                )}
              >
                {row.getVisibleCells().map((cell) => (
                  <div
                    ...
                    className={cn(
                      ...
                      (cell.column.columnDef.meta as { colClass?: string })
                        ?.colClass ?? "flex-1 min-w-0"
                    )}
                  >
