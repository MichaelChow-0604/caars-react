...
function App() {
  ...
  const checkedStaff = staffListWithUser.filter((s) =>
    checkedStaffIds.includes(s.id)
  );
  ...
  const mainApp = (
    <div className="flex flex-1 h-screen min-h-[720px] max-h-[1440px] w-full min-w-[1080px] max-w-[2560px] overflow-hidden bg-caars-neutral-white">
      <MenuBar
        mode={mode}
      ...
      <main className="flex flex-col flex-1 h-screen min-h-[720px] max-h-[1440px] overflow-hidden">
        ...
        <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
          {isPatientHome ? (
            ...
            <Routes>
              <Route
                path="/"
                element={<Navigate to={NAV_PATHS.calendar} replace />}
              />
              <Route
  ...
  return (
    <div className="flex flex-1 h-screen min-h-[720px] max-h-[1440px] w-full min-w-[1080px] max-w-[2560px] flex-col overflow-hidden">
      <Routes>
        <Route
          path="/login"
          element={
